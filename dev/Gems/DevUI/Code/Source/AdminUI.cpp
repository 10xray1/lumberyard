...
namespace DevUI
{
	...
	AdminUI::~AdminUI()
	{
		...
		AdminUIBus::Handler::BusDisconnect();
	}

	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::CreateCanvas()
	{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::Reflect(AZ::ReflectContext* context)
	{
		AZ::BehaviorContext* behaviorContext = azrtti_cast<AZ::BehaviorContext*>(context);
		if (behaviorContext)
		{
			behaviorContext->EBus<AdminUIBus>("AdminUIRequestBus")
				->Event("CreateCanvas", &AdminUIBus::Events::CreateCanvas)
				->Event("DestroyCanvas", &AdminUIBus::Events::DestroyCanvas);
		}
	}
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateBackground()
	{
		// Get the canvas
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::CreateElementsExample(AZ::EntityId foregroundId)
	{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::CreateBehaviorExample(AZ::EntityId foregroundId)
	{
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::CreateComponent(AZ::Entity* entity, const AZ::Uuid& componentTypeId)
	{
		entity->Deactivate();
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateButton(const char* name, bool atRoot, AZ::EntityId parent,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateCheckbox(const char* name, bool atRoot, AZ::EntityId parent,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateText(const char* name, bool atRoot, AZ::EntityId parent,
		UiTransform2dInterface::Anchors anchors, UiTransform2dInterface::Offsets offsets,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateTextInput(const char* name, bool atRoot, AZ::EntityId parent,
		UiTransform2dInterface::Anchors anchors, UiTransform2dInterface::Offsets offsets,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	AZ::EntityId AdminUI::CreateImage(const char* name, bool atRoot, AZ::EntityId parent,
		UiTransform2dInterface::Anchors anchors, UiTransform2dInterface::Offsets offsets,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////
	void AdminUI::UpdateHealth(int change)
	{
